...
def _build_non_max_suppressor(nms_config):
  ...
  non_max_suppressor_fn = functools.partial(
      ...
      soft_nms_sigma=0.0,                         # original code: nms_config.soft_nms_sigma
      use_partitioned_nms=False,                  # original code: nms_config.use_partitioned_nms
      use_combined_nms=False)                     # original code: nms_config.use_combined_nms
