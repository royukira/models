...
_FEATUREPYRAMIDNETWORKS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mnasfpn', full_name='object_detection.protos.FeaturePyramidNetworks.mnasfpn', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MNASFEATUREPYRAMIDNETWORKS = _descriptor.Descriptor(
  name='MnasFeaturePyramidNetworks',
  full_name='object_detection.protos.MnasFeaturePyramidNetworks',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mnas_depth_multiplier', full_name='object_detection.protos.MnasFeaturePyramidNetworks.mnas_depth_multiplier', index=0,
...
_FEATUREPYRAMIDNETWORKS.fields_by_name['mnasfpn'].message_type = _MNASFEATUREPYRAMIDNETWORKS
...
DESCRIPTOR.message_types_by_name['MnasFeaturePyramidNetworks'] = _MNASFEATUREPYRAMIDNETWORKS
...
MnasFeaturePyramidNetworks = _reflection.GeneratedProtocolMessageType('MnasFeaturePyramidNetworks', (_message.Message,), dict(
  DESCRIPTOR = _MNASFEATUREPYRAMIDNETWORKS,
  __module__ = 'object_detection.protos.ssd_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.MnasFeaturePyramidNetworks)
  ))
_sym_db.RegisterMessage(MnasFeaturePyramidNetworks)
