...
_LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_giou', full_name='object_detection.protos.LocalizationLoss.weighted_giou', index=3,
